...
/// An edge representing a HAS_EPISODE relationship from a saga node to an episodic node.
...
mod tests {
    ...
    #[test]
    fn has_episode_edge_can_be_constructed() {
    ...
    #[test]
    fn has_episode_edge_serializes_to_json() {
        let edge = HasEpisodeEdge {
            uuid: Uuid::new_v4(),
    ...
    #[test]
    fn has_episode_edge_deserializes_from_json() {
        ...
        let edge: HasEpisodeEdge = serde_json::from_str(&json).unwrap();
